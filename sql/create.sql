insert into dps_user(user_id, login, password, first_name, gender, email, date_of_birth)
            values (1, 'andre', 'Andrei', 'andre', 0, 'andrey.evans@gmail.com', to_date('03-MAR-1994'));
