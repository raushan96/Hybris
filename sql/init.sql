...
values (1, '$2a$08$b.VA8Yn45uIow6nAFWSU1.cWGPVeu1ZKWhSmit7PVB4xST53EmX.S', 'andre', 'evans', 0, 'andrey.evans@gmail.com', to_date('03-MAR-1994'));
...
insert into dps_giftlist(gift_list_id, user_id, is_published, creation_date, shipping_addr_id)
values (1, 1, 1, to_date('01-MAR-2018'), 1);
