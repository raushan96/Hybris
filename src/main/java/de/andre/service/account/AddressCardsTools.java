...
@Service
public class AddressCardsTools {
	private final AddressRepository addressRepository;
	private final UserRepository userRepository;
	private final AccountTools accountTools;

	@Autowired
	public AddressCardsTools(final AddressRepository addressRepository, final UserRepository userRepository, final AccountTools accountTools) {
